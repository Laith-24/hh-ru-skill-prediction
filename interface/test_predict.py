...
from data_pipeline import TITLE_FEATURE_COLS, load_and_engineer, safe_skill_name, extract_basic_features, _add_experience_and_work_format

DATA_PATH = str(ROOT / "data" / "vacancies.parquet")
N_SKILLS = 50
SKILL_LIST_PATH = str(ROOT / "configs" / "top_skills_50.json")
CATBOOST_MODELS_DIR = ROOT / "models" / "title_only_top50" / "catboost"
RESULTS_PATH = ROOT / "results" / "title_only_results_top50.csv"
