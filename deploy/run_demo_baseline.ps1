...
spark-submit --master local[2] --driver-memory 4g --conf spark.sql.parquet.columnarReaderBatchSize=512 --conf spark.sql.shuffle.partitions=8 --conf spark.default.parallelism=8 --conf spark.local.dir="C:\Users\LAITH AHMAD\Desktop\BD\hh-ru-skill-prediction\spark-tmp" src/train_nonspark_models.py --data "data/demo/demo_old.parquet" --output "results/demo_nonspark_baseline.csv" --models-dir "models/nonspark_demo" --pipeline-path "models/feature_pipeline_demo"
spark-submit --master local[2] --driver-memory 4g --conf spark.sql.parquet.columnarReaderBatchSize=512 --conf spark.sql.shuffle.partitions=8 --conf spark.default.parallelism=8 --conf spark.local.dir="C:\Users\LAITH AHMAD\Desktop\BD\hh-ru-skill-prediction\spark-tmp" src/train_spark_native.py --data "data/demo/demo_old.parquet" --output "results/demo_spark_baseline.csv" --models-dir "models/spark_demo" --pipeline-path "models/feature_pipeline_demo"
