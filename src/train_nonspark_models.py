...
from data_pipeline import load_and_engineer, safe_skill_name, best_f1_threshold
...
def main():
    ...
    df_features, top_skills, pipeline_model = load_and_engineer(spark, args.data, args.top_n_skills)
    ...
    pdf = df_features.select(["split", "features_array"] + label_cols).toPandas()
